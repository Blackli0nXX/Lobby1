...
class IllegalPistolMenu
{
	...
	class BuyAmmo : BaseRscButton
	{
		idc = 11171;
		text = "Buy Ammo";
		action = "execVM 'weapons\illegalpistolammobuy.sqf'";
		x = 0.65; y = 0.575;
		w = 0.5;
	};
	class Close : BaseRscButton
...
class IllegalRifleMenu
{
	...
	class BuyAmmo : BaseRscButton
	{
		idc = 11175;
		text = "Buy Ammo";
		action = "execVM 'weapons\illegalrifleammobuy.sqf'";
		x = 0.65; y = 0.575;
		w = 0.5;
	};
	class Close : BaseRscButton
