...
//weatherFunction = compile preprocessFileLineNumbers "Scripts\DRN\DynamicWeatherEffects\DynamicWeatherEffects.sqf";
//timeFunction = compile preprocessFileLineNumbers "Scripts\dyntime2.sqf";
...
allCollectingTriggers = [   [trgTrufflefield1], // Truffle triggers
...
execVM "AdminMoney.sqf";
execVM "DonorSpawn.sqf";

//Dynamic Time
// [] execVM "Scripts\dyntime2.sqf";
