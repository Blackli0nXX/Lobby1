...
/* Start of 31st Tactical Regiment MOTD */
    ...
    // Generic 31st Tactical Regiment
    _tmpStr = ""
            + ""
            + ""
            + "";
...
/* End of 31st Tactical Regiment MOTD */


/* Start of 31st Tactical Regiment Rules */
...
/* End of 31st Tactical Regiment Rules */
