...
gotwoodinv = format ["<t color='#B5FF8A' size='1'>Wood:</t><t color='#4CCF00' size='1'> %1</t> <br/>", (player getVariable "itemwood")];
}
else {
gotwoodinv = format [""];
};

if ((player getVariable "itemrabbitmeat") > 0) then {
gotmeatinv = format ["<t color='#B5FF8A' size='1'>Rabbit Meat:</t><t color='#4CCF00' size='1'> %1</t> <br/>", (player getVariable "itemrabbitmeat")];
}
else {
gotmeatinv = format [""];
};
